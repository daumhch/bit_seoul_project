...
x_train, y_train = search('D:\\bit_seoul_project\\3rd_project\\201214\\data\\nsynth-train\\audio')
np.save('./3rd_project/201214/data/x_train_11025sr.npy', arr = x_train)
np.save('./3rd_project/201214/data/y_train_11025sr.npy', arr = y_train)

x_val, y_val = search('D:\\bit_seoul_project\\3rd_project\\201214\\data\\nsynth-valid\\audio')
np.save('./3rd_project/201214/data/x_val_11025sr.npy', arr = x_val)
np.save('./3rd_project/201214/data/y_val_11025sr.npy', arr = y_val)

x_test, y_test = search('D:\\bit_seoul_project\\3rd_project\\201214\\data\\nsynth-test\\audio')
np.save('./3rd_project/201214/data/x_test_11025sr.npy', arr = x_test)
np.save('./3rd_project/201214/data/y_test_11025sr.npy', arr = y_test)
